        ...
        <main className='learn'>
            ...
            <section className='learn__cards'>
                <div className='learn__card' onClick={navigateHiragana}>
                    ...
                    <video className='learn__video' src={mountFuji} autoPlay loop muted playsInline disableRemotePlayback />
                </div>
                <div className='learn__card' onClick={navigateKatakana}>
                    <div className='learn__overlay'>Katakana カタカナ</div>
                    <video className='learn__video' src={road} autoPlay loop muted playsInline disableRemotePlayback />
                </div>
            </section>
        </main>
    )
